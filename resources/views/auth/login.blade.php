                ...
                <div class="flex flex-col items-center justify-between pt-0 pr-10 pb-0 pl-10 mt-0 mr-auto mb-0 ml-auto max-w-7xl xl:px-5 lg:flex-row">
                    <div class="flex flex-col items-center w-full pt-5 pr-10 pb-20 pl-10 lg:pt-20 lg:flex-row">
                        ...
                        <div class="w-full mt-20 mr-0 mb-0 ml-0 relative z-10 max-w-2xl lg:mt-0 lg:w-5/12">
                            <div class="flex flex-col items-center justify-center pt-10 pr-10 pb-10 pl-10 bg-white shadow-2xl rounded-xl relative z-10">
                                <div class="text-center mb-10">
                                    <h1 class="font-bold text-3xl text-gray-900">Sign In</h1>
                                    <p class="mt-3">Enter your information to login</p>
                                </div>
                            <div>
                            ...
                            <!-- @method('post') -->
                                ...
                                <div class="flex -mx-3">
                                    <div class="w-full px-3 mb-5">
                                        <button type="submit" class="block w-full max-w-xs mx-auto bg-indigo-500 hover:bg-indigo-700 focus:bg-indigo-700 text-white rounded-lg px-3 py-3 font-semibold">Login NOW</button>
                                    </div>
                                </div>
                            </form>
                        </div>
                        <div class="w-full text-center">
                            <a href="/auth/register" class="text-indigo-500">New ? Create an account.</a>
                        </div>
                     </div>
